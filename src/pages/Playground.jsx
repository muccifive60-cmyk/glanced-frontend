  ...
  useEffect(() => {
    ...
    const initializeVapi = async () => {
        try {
            ...
            // Tunatumia ESM.SH - Hii ni magic link inayofanya kazi 100% kwenye Browser
            // Haitegemei npm wala window
    ...
    if (isTalking) {
      ...
      try {
        ...
        await vapiRef.current.start(VAPI_ASSISTANT_ID, {
            ...
            variableValues: { userId: user?.id, modelId: selectedModel?.id }
        })
      } catch (err) {
